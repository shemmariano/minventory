...
A lightweight, internal inventory table modeled from a small clothing resale operations. Track items, manage product status, and keep everything organized behind a simple login.
